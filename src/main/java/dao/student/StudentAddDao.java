...
public class StudentAddDao extends BaseDao {
  public boolean insert(StudentData s) throws SQLException {
    String sql = """
      INSERT INTO `students`
        (student_number, last_name, first_name, last_name_kana, first_name_kana,
